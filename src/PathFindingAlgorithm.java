...
class ClosestNeighbourPath {
     ...
     * index of Plane
     */
    final int PLANE = MetricsGraph.PLANE_INDEX;
    /**
     * offset of horses in list
     */
    final int HORSE_OFFSET = 2;

    /**
     * Finds the closest horse to the plane in the graph
     * this is the same as calling <code>findClosestHorseToNode(graph,src.MetricsGraph.PLANE_INDEX)</code>
     *
    ...
    /**
     * Finds the closest src.Horse meeting some requirements (see below) in the graph to the node on the specified index in the graph
...
//        double MAX_DIST = 1000.0;
        ...
        return (
                ...
                //graph.getWeight(src.MetricsGraph.PLANE_INDEX,horseIndex)<MAX_DIST
        );
    }
}
