...
class MetricsGraph {
     ...
     * can be: src.Horse Index, Paris index (0) or Plane index (1) at the beginning
     */
    currentlyAt;
    /**
    ...
    /**
     * Getter for instance of src.Aircraft
     *
     * @return Airplane assigned to graph
     */
    ...
    /**
     * If the horse is already visited, returns true
     *
     * @param i index of horse
...
// */
//class TreeSetGraph{
//    TreeSet<src.GraphNode> nodes;
//    src.GraphNode paris;
//    src.Aircraft plane;
//
//    TreeSetGraph(src.Horse[] horses, src.Aircraft plane, src.GraphNode paris, Comparator<src.GraphNode> comp) {
//        nodes = new TreeSet<>(comp);
//        for (src.Horse horse :horses) {
...
//    }
//
//    public src.Horse closestToPlane(){
//        src.GraphNode closest = nodes.ceiling(plane);
//        if(closest==null) {
//            closest = nodes.first();
//        }
//        return (src.Horse) closest;
//    }
//
//    public src.Aircraft getPlane(){
//        return  plane;
//    }
//
...
//    }
//    public void delete(src.Horse h){
//        nodes.remove(h);
//    }
//}
